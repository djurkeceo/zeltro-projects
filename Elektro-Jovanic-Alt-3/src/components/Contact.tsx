      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
          ...
          >
            <a
              href="tel:0642072352"
              className="bg-brand-surface2 p-6 rounded-lg border border-white/5 hover:border-brand-gold transition-all group flex items-start gap-4"
            >
              ...
              <div>
                <h4 className="text-brand-text-sec text-sm uppercase tracking-wider mb-1">
                  Telefon
                </h4>
                <p className="text-brand-white text-xl font-medium group-hover:text-brand-gold transition-colors">
                  064 / 207-2352
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-brand-white text-lg font-medium group-hover:text-brand-gold transition-colors break-all">
            ...
            <div className="bg-brand-surface2 p-6 rounded-lg border border-white/5 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-brand-white text-lg font-medium">
                  Majšanski put 134A
                  <br />
                  24000 Subotica
                </p>
          ...
          >
            {submitted ? (
              ...
              >
                ...
                <h3 className="text-2xl font-heading text-brand-white mb-2">
                  Poruka Poslata!
                </h3>
                <p className="text-brand-text-sec text-center px-6">
                  Hvala na interesovanju. Kontaktiraćemo vas u najkraćem mogućem
                  roku.
                </p>
              </motion.div>
            ) : null}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              <h3 className="font-heading text-2xl text-brand-white tracking-wider mb-2">
                Pošaljite upit
              </h3>
              ...
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="name"
                  className="text-brand-text-sec text-sm uppercase tracking-wide"
                >
                  Ime i prezime
                </label>
                <input
